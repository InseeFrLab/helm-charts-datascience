...
Common labels
*/}}
{{- define "rapidsai.labels" -}}
helm.sh/chart: {{ include "rapidsai.chart" . }}
{{ include "rapidsai.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "rapidsai.selectorLabels" -}}
app.kubernetes.io/name: {{ include "rapidsai.name" . }}
...
*/}}
{{- define "rapidsai.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "rapidsai.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "rapidsai.configMapNameS3" -}}
{{- if .Values.s3.create }}
{{- $name:= (printf "%s-configmaps3" (include "rapidsai.fullname" .) )  }}
...
ingress annotations 
*/}}
{{- define "rapidsai.ingress.annotations" -}}
