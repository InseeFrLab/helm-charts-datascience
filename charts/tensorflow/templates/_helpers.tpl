...
*/}}
{{- define "tensorflow.configMapNameS3" -}}
{{- if .Values.s3.create }}
{{- $name:= (printf "%s-configmaps3" (include "tensorflow.fullname" .) )  }}
...
*/}}
{{- define "tensorflow.configMapNameVault" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapvault" (include "tensorflow.fullname" .) )  }}
...
*/}}
{{- define "tensorflow.configMapNameGit" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapgit" (include "tensorflow.fullname" .) )  }}
...
ingress annotations 
*/}}
{{- define "tensorflow.ingress.annotations" -}}
