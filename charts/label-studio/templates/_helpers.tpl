...
*/}}
{{- define "label-studio.configMapNameS3" -}}
{{- if .Values.s3.create }}
{{- $name:= (printf "%s-configmaps3" (include "label-studio.fullname" .) )  }}
...
*/}}
{{- define "label-studio.configMapNameVault" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapvault" (include "label-studio.fullname" .) )  }}
...
*/}}
{{- define "label-studio.configMapNameGit" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapgit" (include "label-studio.fullname" .) )  }}
...
ingress annotations 
*/}}
{{- define "label-studio.ingress.annotations" -}}
