...
*/}}
{{- define "spark-history.configMapNameS3" -}}
{{- if .Values.s3.create }}
{{- $name:= (printf "%s-configmaps3" (include "spark-history.fullname" .) )  }}
...
*/}}
{{- define "spark-history.configMapNameVault" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapvault" (include "spark-history.fullname" .) )  }}
...
*/}}
{{- define "spark-history.configMapNameGit" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapgit" (include "spark-history.fullname" .) )  }}
...
ingress annotations 
*/}}
{{- define "spark-history.ingress.annotations" -}}
